...
<br/>
    ...
    <h2>Mathematics (SL/HL)</h2>
    <br>
      <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'Math' ORDER BY a_downloads*a_rating DESC" ;
    ...
    <h2>Computer Science (SL/HL)</h2>
    <br/>
    <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'Computer Science' ORDER BY a_downloads*a_rating DESC" ;
      $result = mysqli_query($conn, $sql);
      $queryResults = mysqli_num_rows($result);
      //echo "queryResults: " . $queryResults;
      $count = 0;
    ...
    <br/>
    <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'Math Studies' ORDER BY a_downloads*a_rating DESC" ;
      $result = mysqli_query($conn, $sql);
      $queryResults = mysqli_num_rows($result);
      //echo "queryResults: " . $queryResults;
      $count = 0;
