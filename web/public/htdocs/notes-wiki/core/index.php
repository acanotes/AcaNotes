...
<br/>
    ...
    <br>
      <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'TOK' ORDER BY a_downloads*a_rating DESC" ;
    ...
    <br/>
    <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'EE' ORDER BY a_downloads*a_rating DESC" ;
      $result = mysqli_query($conn, $sql);
      $queryResults = mysqli_num_rows($result);
      //echo "queryResults: " . $queryResults;
      $count = 0;
      ...
      <br/>
      <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'CAS' ORDER BY a_downloads*a_rating DESC" ;
      $result = mysqli_query($conn, $sql);
      $queryResults = mysqli_num_rows($result);
      //echo "queryResults: " . $queryResults;
      $count = 0;
