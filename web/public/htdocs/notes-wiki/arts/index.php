...
<br/>
    ...
    <br>
      <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'Film' ORDER BY a_downloads*a_rating DESC" ;
    ...
    <br/>
    <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'Music' ORDER BY a_downloads*a_rating DESC" ;
      $result = mysqli_query($conn, $sql);
      $queryResults = mysqli_num_rows($result);
      //echo "queryResults: " . $queryResults;
      $count = 0;
    ...
    <br/>
    <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'Theatre' ORDER BY a_downloads*a_rating DESC" ;
      $result = mysqli_query($conn, $sql);
      $queryResults = mysqli_num_rows($result);
      //echo "queryResults: " . $queryResults;
      $count = 0;
    ...
    <h2>Visual Arts (SL/HL)</h2>
    <br/>
    <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'Visual Arts' ORDER BY a_downloads*a_rating DESC" ;
      $result = mysqli_query($conn, $sql);
      $queryResults = mysqli_num_rows($result);
      //echo "queryResults: " . $queryResults;
      $count = 0;
