...
<br/>
    ...
    <br>
      <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'Physics' ORDER BY a_downloads*a_rating DESC" ;
    ...
    <h2>Chemistry (SL/HL)</h2>
    <br/>
    <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'Chemistry' ORDER BY a_downloads*a_rating DESC" ;
      $result = mysqli_query($conn, $sql);
      $queryResults = mysqli_num_rows($result);
      //echo "queryResults: " . $queryResults;
      $count = 0;
    ...
    <br/>
    <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'Biology' ORDER BY a_downloads*a_rating DESC" ;
      $result = mysqli_query($conn, $sql);
      $queryResults = mysqli_num_rows($result);
      //echo "queryResults: " . $queryResults;
      $count = 0;
    ...
    <br/>
    <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'ESS' ORDER BY a_downloads*a_rating DESC" ;
      $result = mysqli_query($conn, $sql);
      $queryResults = mysqli_num_rows($result);
      //echo "queryResults: " . $queryResults;
      $count = 0;
...
<br/>
    <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'Sports Science' ORDER BY a_downloads*a_rating DESC" ;
      $result = mysqli_query($conn, $sql);
      $queryResults = mysqli_num_rows($result);
      //echo "queryResults: " . $queryResults;
      $count = 0;
