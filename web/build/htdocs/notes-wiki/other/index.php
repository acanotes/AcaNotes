...
-->
<br/>
<p>Listing top 20 notes, as determined by rating and number of downloads.</p>
<br/>

    <h2>Other classes</h2>
    <br>
      <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'Other' ORDER BY a_downloads*a_rating DESC" ;
