  ...
  <main class='content-wrapper'>
    <center>
      <div class='fullwidth' id='title-head-wrapper'>
        <div id='title-head'>
          <h1>Group 3: Individuals and Societies</h1>
        </div>
      </div>
      <br>
...
<br/>
    ...
    <h2>Economics (SL/HL)</h2>
    <br>
      <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'Economics' ORDER BY a_downloads*a_rating DESC" ;
    ...
    <h2>Geography (SL/HL)</h2>
    <br/>
    <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'Geography' ORDER BY a_downloads*a_rating DESC" ;
      $result = mysqli_query($conn, $sql);
      $queryResults = mysqli_num_rows($result);
      //echo "queryResults: " . $queryResults;
      $count = 0;
    ...
    <h2>Global Politics (SL/HL)</h2>
    <br/>
    <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'Global Politics' ORDER BY a_downloads*a_rating DESC" ;
      $result = mysqli_query($conn, $sql);
      $queryResults = mysqli_num_rows($result);
      //echo "queryResults: " . $queryResults;
      $count = 0;
    ...
    <br/>
    <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'History' ORDER BY a_downloads*a_rating DESC" ;
      $result = mysqli_query($conn, $sql);
      $queryResults = mysqli_num_rows($result);
      //echo "queryResults: " . $queryResults;
      $count = 0;
...
<h2>Psychology (SL/HL)</h2>
<br/>
    <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'Psychology' ORDER BY a_downloads*a_rating DESC" ;
      $result = mysqli_query($conn, $sql);
      $queryResults = mysqli_num_rows($result);
      //echo "queryResults: " . $queryResults;
      $count = 0;
...
<br/>
    <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'ITGS' ORDER BY a_downloads*a_rating DESC" ;
      $result = mysqli_query($conn, $sql);
      $queryResults = mysqli_num_rows($result);
      //echo "queryResults: " . $queryResults;
      $count = 0;
...
<br/>
    <?php
      $sql = "SELECT * FROM notes WHERE a_subject = 'Business and Mgmt' ORDER BY a_downloads*a_rating DESC" ;
      $result = mysqli_query($conn, $sql);
      $queryResults = mysqli_num_rows($result);
      //echo "queryResults: " . $queryResults;
      $count = 0;
