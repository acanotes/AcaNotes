<?php
            ...
            if (isset($_POST['commentSubmit']))
            {
                ...
                $sql = "INSERT INTO comments6(uid, creator, date, message) VALUES ('$uid', '$creatorid','$date', '$message')";
            ...
            function editComments($conn)
            {
                if (isset($_POST['commentSubmit']))
                {
                    ...
                    $sql = "UPDATE comments6 SET message='$message' WHERE cid='$cid'";

                    $result = $conn->query($sql);
                    echo "<script>location.href='../topic/6
        ...
        function deleteComments($conn)
        {
            ...
            {
                $cid = $_POST['cid'];
                $sql = "DELETE FROM comments6 WHERE cid='$cid'";
                $result = $conn->query($sql);
                echo "<script>location.href='../topic/6.php';</script>"; #got it -Tom21487
                }
            }
        ?>