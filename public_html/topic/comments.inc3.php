<?php
            ...
            if (isset($_POST['commentSubmit']))
            {
                ...
                $sql = "INSERT INTO comments3(uid, creator, date, message) VALUES ('$uid', '$creatorid','$date', '$message')";
            ...
            function editComments($conn)
            {
                if (isset($_POST['commentSubmit']))
                {
                    ...
                    $result = $conn->query($sql);
                    echo "<script>location.href='../topic/3
        ...
        function deleteComments($conn)
        {
            ...
            {
                $cid = $_POST['cid'];
                $sql = "DELETE FROM comments3WHERE cid='$cid'";
                $result = $conn->query($sql);
                echo "<script>location.href='../topic/3 WHERE cid='$cid'";
                $result = $conn->query($sql);
                echo "<script>location.href='../topic/
        
        .php';</script>"; #got it -Tom21487
                }
            }
        ?>