<?php
            ...
            if (isset($_POST['commentSubmit']))
            {
                ...
                $sql = "INSERT INTO comments5(uid, creator, date, message) VALUES ('$uid', '$creatorid','$date', '$message')";
            ...
            function editComments($conn)
            {
                if (isset($_POST['commentSubmit']))
                {
                    ...
                    $result = $conn->query($sql);
                    echo "<script>location.href='../topic/5
        ...
        function deleteComments($conn)
        {
            ...
            {
                $cid = $_POST['cid'];
                $sql = "DELETE FROM comments5 WHERE cid='$cid'";
                $result = $conn->query($sql);
                echo "<script>location.href='../topic/5.php';</script>"; #got it -Tom21487
                }
            }
        ?>