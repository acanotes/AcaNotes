<?php
            ...
            if (isset($_POST['commentSubmit']))
            {
                ...
                $sql = "INSERT INTO comments2(uid, creator, date, message) VALUES ('$uid', '$creatorid','$date', '$message')";
            ...
            function editComments($conn)
            {
                if (isset($_POST['commentSubmit']))
                {
                    ...
                    $result = $conn->query($sql);
                    echo "<script>location.href='../topic/2
        ...
        function deleteComments($conn)
        {
            if (isset($_POST['commentDelete']))
            {
                ...
                $result = $conn->query($sql);
                echo "<script>location.href='../topic/2.php';</script>"; #got it -Tom21487
                }
            }
        ?>