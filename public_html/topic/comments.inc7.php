<?php
            ...
            if (isset($_POST['commentSubmit']))
            {
                ...
                $sql = "INSERT INTO comments7(uid, creator, date, message) VALUES ('$uid', '$creatorid','$date', '$message')";
            ...
            function editComments($conn)
            {
                if (isset($_POST['commentSubmit']))
                {
                    ...
                    $sql = "UPDATE comments7 SET message='$message' WHERE cid='$cid'";

                    $result = $conn->query($sql);
                    echo "<script>location.href='../topic/7
        ...
        function deleteComments($conn)
        {
            ...
            {
                $cid = $_POST['cid'];
                $sql = "DELETE FROM comments7 WHERE cid='$cid'";
                $result = $conn->query($sql);
                echo "<script>location.href='../topic/7.php';</script>"; #got it -Tom21487
                }
            }
        ?>